...
const translations = {
  ...
  // Sign Up
  "signup.title": { ar: "إنشاء حساب جديد", en: "Create Account" },
  "signup.subtitle": { ar: "اختر دورك وابدأ رحلتك مع بوصلة", en: "Choose your role and start your journey with Boslah" },
  "signup.role": { ar: "ما دورك؟", en: "What's your role?" },
  "signup.student": { ar: "طالب", en: "Student" },
  "signup.uni": { ar: "جامعة", en: "University" },
  "signup.name": { ar: "الاسم الكامل", en: "Full name" },
  "signup.namePh": { ar: "مثال: أحمد محمود", en: "Example: Ahmed Mahmoud" },
  "signup.email": { ar: "البريد الإلكتروني", en: "Email address" },
  "signup.emailPh": { ar: "مثال: ahmed@gmail.com", en: "Example: ahmed@gmail.com" },
  "signup.username": { ar: "اسم المستخدم", en: "Username" },
  "signup.usernamePh": { ar: "اختر اسماً فريداً", en: "Choose a unique username" },
  "signup.usernameHint": { ar: "ستسجل الدخول باسم المستخدم هذا", en: "You'll login with this username" },
  "signup.pass": { ar: "كلمة المرور", en: "Password" },
  "signup.passPh": { ar: "أدخل 6 أحرف على الأقل", en: "At least 6 characters" },
  "signup.passHint": { ar: "استخدم أحروفاً وأرقاماً لأمان أفضل", en: "Use letters and numbers for better security" },
  "signup.confirmPass": { ar: "تأكيد كلمة المرور", en: "Confirm password" },
  "signup.confirmPassPh": { ar: "أعد كتابة كلمتك المرورية", en: "Retype your password" },
  "signup.loading": { ar: "جاري الإنشاء...", en: "Creating..." },
  "signup.btn": { ar: "إنشاء الحساب", en: "Sign Up" },
  "signup.hasAccount": { ar: "هل لديك حساب بالفعل؟ ", en: "Already have an account? " },
  "signup.login": { ar: "تسجيل الدخول", en: "Log in" },
  "signup.success": { ar: "تم إنشاء الحساب! سيتم نقلك للدخول...", en: "Account created! Redirecting to login..." },
  "signup.err.name": { ar: "أدخل اسماً كاملاً", en: "Enter a full name" },
  "signup.err.email": { ar: "أدخل بريداً إلكترونياً صحيحاً", en: "Enter a valid email" },
  "signup.err.username": { ar: "أدخل اسم مستخدم", en: "Enter a username" },
  "signup.err.pass": { ar: "كلمة المرور يجب أن تكون 6 أحرف على الأقل", en: "Password must be at least 6 characters" },
  "signup.err.passMatch": { ar: "كلمات المرور غير متطابقة", en: "Passwords don't match" },
  "signup.err.exists": { ar: "اسم المستخدم موجود بالفعل", en: "Username already exists" },
  "signup.err.unknown": { ar: "خطأ غير متوقع", en: "Unexpected error" },

  // Login
  "login.title": { ar: "تسجيل الدخول", en: "Sign In" },
  "login.subtitle": { ar: "أدخل بريدك الإلكتروني وكلمة المرور", en: "Enter your email and password" },
  "login.student": { ar: "طالب / جامعة", en: "Student / University" },
  "login.admin": { ar: "إداري", en: "Admin" },
  "login.email": { ar: "البريد الإلكتروني", en: "Email" },
  "login.emailPh": { ar: "مثال: name@gmail.com", en: "Example: name@gmail.com" },
  "login.pass": { ar: "كلمة المرور", en: "Password" },
  "login.passPh": { ar: "أدخل كلمتك المرورية", en: "Enter your password" },
  ...
  "login.signup": { ar: "أنشئ حساباً جديداً", en: "Create one" },
  "login.success": { ar: "تم تسجيل الدخول بنجاح!", en: "Signed in successfully!" },
  "login.err.email": { ar: "أدخل بريدك الإلكتروني", en: "Enter your email" },
  "login.err.pass": { ar: "أدخل كلمة المرور", en: "Enter your password" },
  "login.err.notAdmin": { ar: "هذا البريد ليس مصرحاً به كإداري", en: "This email is not authorized as an admin" },
  "login.err.unknown": { ar: "خطأ في تسجيل الدخول", en: "Sign in failed" },

  // Admin Dashboard
  "admin.title": { ar: "لوحة الإدارة", en: "Admin Dashboard" },
  "admin.subtitle": { ar: "راجع الملفات المرفوعة واوافق عليها", en: "Review and approve uploaded files" },
  "admin.noUploads": { ar: "لا توجد ملفات بانتظار المراجعة", en: "No files pending review" },
  "admin.notes": { ar: "ملاحظات", en: "Notes" },
  "admin.approve": { ar: "موافقة", en: "Approve" },
  "admin.reject": { ar: "رفض", en: "Reject" },
  "admin.retry": { ar: "إعادة محاولة", en: "Retry" },
  "admin.download": { ar: "تحميل", en: "Download" },
  "admin.status.pending": { ar: "بانتظار المراجعة", en: "Pending" },
  "admin.status.processing": { ar: "قيد المعالجة", en: "Processing" },
  "admin.status.processed": { ar: "تم المعالجة", en: "Processed" },
  "admin.status.rejected": { ar: "مرفوضة", en: "Rejected" },
  "admin.status.error": { ar: "خطأ", en: "Error" },
  "admin.approveSuccess": { ar: "تم قبول الملف", en: "File approved" },
  "admin.rejectSuccess": { ar: "تم رفض الملف", en: "File rejected" },
  "admin.err.loadFailed": { ar: "فشل تحميل الملفات", en: "Failed to load files" },
  "admin.err.approveFailed": { ar: "فشل قبول الملف", en: "Failed to approve file" },
  "admin.err.rejectFailed": { ar: "فشل رفض الملف", en: "Failed to reject file" },
